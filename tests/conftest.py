    ...
    class FinTSHandler(http.server.BaseHTTPRequestHandler):
        ...
        def make_answer(self, dialog_id, message):
            ...
            if pin not in ('1234', '3938'):
                return "HIRMG::2+9910::Pin ungültig'".encode()
            ...
            if hkvvb:
                ...
                if pin == '3938':
                    responses.append(br'3938::Ihr Zugang ist vorl\u00e4ufig gesperrt - Bitte PIN-Sperre aufheben.')
                else:
            ...
            if b"'HKSYN:" in message:
                system_id = f"{system_prefix};{len(systems)+1:05d}"
                systems[system_id] = {}
                result.append(f"HISYN::4:5+{system_id}'".encode('us-ascii'))
                    ...
                    if memomatch.group(1).endswith('1step'):
                        ...
                        if hktan:
                            ...
                            if 'hhduc' in memomatch.group(1):
                                ...
                                tanmsg = f"CHLGUC  00312908{newtan}1012345678900523,42CHLGTEXT0034Geben Sie den Startcode als TAN an"
                            else:
                                newtan = '123456'
                                tanmsg = f"Geben Sie TAN {newtan} an"
            ...
            if hktan:
                ...
                if task:
                    if tan == task['tan']:
                        ...
                        result.append(f"HIRMS::2:{segno}+9941::TAN ungültig'".encode('iso-8859-1'))
        ...
        def process_message(self, message):
            ...
            if incoming_dialog_id:
                ...
                if dialog_id == '0':
                    dialog_id = f"{dialog_prefix};{len(dialogs)+1:05d}"
